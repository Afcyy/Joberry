    ...
    <div class="container flex flex-col flex-wrap items-center justify-between py-5 mx-auto md:flex-row max-w-7xl">
        <div class="relative flex flex-col md:flex-row">
            ...
            <nav class="flex flex-wrap items-center mb-5 text-base md:mb-0 md:pl-8 md:ml-8 md:border-l md:border-gray-200">
                ...
                <a href="#_" class="mr-5 font-medium leading-6 text-indigo-600 hover:text-indigo-500">კომპანიები</a>
                <a href="#_" class="mr-5 font-medium leading-6 text-gray-600 hover:text-gray-900">ვაკანსიები</a>

            </nav>
        </div>

        <div class="inline-flex items-center ml-5 space-x-6 lg:justify-end">
            <a href="login.blade.php" class="text-base font-medium leading-6 text-gray-600 whitespace-no-wrap transition duration-150 ease-in-out hover:text-indigo-600">
                ავტორიზაცია
            </a>
...
<h3 class="text-gray-700 text-3xl font-medium">მომხარებლები</h3>
<div class="mt-8">
                    ...
                    <div class="gapy-6">
                        <div class="grid grid-cols-4 gap-2 p-2 rounded">
                            <div class="flex border rounded-md bg-gray-100 items-center p-2 ">
                                <svg class="fill-current text-gray-500 mr-2 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
...
<div id="container" class="w-full mx-auto">
    <div class="grid grid-cols-5 gap-4 my-6">
      <!-- Card 1 -->
      <div class="w-full">
        <div class="bg-white px-6 py-8 rounded-md border border-gray-200 text-center">
          <div class="mb-3">
            <img
              class="w-40 mx-auto rounded-full"
              src="https://randomuser.me/api/portraits/women/65.jpg"
              alt=""
            />
          </div>
          <h2 class="text-xl font-medium text-gray-700">კიტი კარლსონი</h2>
          <span class="text-blue-500 block">მოლარე</span>
	  <p class="font-medium block mb-5 text-sm">ლოკაცია: <span class="text-gray-600">თბილისი</span></p>
...
<div class="w-full">
        <div class="bg-white px-6 py-8 rounded-md border border-gray-200 text-center">
          ...
          <h2 class="text-xl font-medium text-gray-700">რობერტო პეინი</h2>
          <span class="text-blue-500 block">Front End Developer</span>
	  <p class="font-medium block mb-5 text-sm">ლოკაცია: <span class="text-gray-600">თბილისი</span></p>
...
<div class="w-full">
        <div class="bg-white px-6 py-8 rounded-md border border-gray-200 text-center">
          ...
          <h2 class="text-xl font-medium text-gray-700">პანდე მულო</h2>
          <span class="text-blue-500 block">Back End Developer</span>
	  <p class="font-medium block mb-5 text-sm">ლოკაცია: <span class="text-gray-600">ბათუმი</span></p>
...
<div class="w-full">
        <div class="bg-white px-6 py-8 rounded-md border border-gray-200 text-center">
          ...
          <h2 class="text-xl font-medium text-gray-700">ჯონ დო</h2>
          <span class="text-blue-500 block">მენაგვე</span>
	  <p class="font-medium block mb-5 text-sm">ლოკაცია: <span class="text-gray-600">თბილისი</span></p>
...
<div class="w-full">
        <div class="bg-white px-6 py-8 rounded-md border border-gray-200 text-center">
          ...
          <h2 class="text-xl font-medium text-gray-700">პანდე მულიადა</h2>
          <span class="text-blue-500 block">Front End Developer</span>
	  <p class="font-medium block mb-5 text-sm">ლოკაცია: <span class="text-gray-600">თბილისი</span></p>
